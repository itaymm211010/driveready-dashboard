...
-- Validation trigger for students gender & license_type
CREATE OR REPLACE FUNCTION public.validate_student_fields()
...
CREATE TRIGGER validate_student_fields_trigger
  BEFORE INSERT OR UPDATE ON public.students
  FOR EACH ROW EXECUTE FUNCTION public.validate_student_fields();
